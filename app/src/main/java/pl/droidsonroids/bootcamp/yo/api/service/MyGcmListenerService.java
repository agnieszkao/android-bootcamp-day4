...
import pl.droidsonroids.bootcamp.yo.MainActivity;
...
public class MyGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        String username = message.substring(0, message.length()-13);
    ...
    private void sendNotification(String message, String username) {
        ...
        notificationManager.notify(username ,0 /* ID of notification */, notificationBuilder.build());
    }
